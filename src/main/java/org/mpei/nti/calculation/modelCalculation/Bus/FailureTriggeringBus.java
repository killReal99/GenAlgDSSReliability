...
public class FailureTriggeringBus {
    ...
    public static float failureTriggeringCalculation(SubstationMeasuresPerYear substationMeasuresPerYear, int iedIndex,
        ...
        float PotkIED = failure.getA31() * A32 * DD16 * DD23 + failure.getA33() * A34 * DD16 * DD23 + failure.getA35() *
                A36 * DD10 * DD19 * DD23 + failure.getA37() * A38 * DD16 * DD23 + failure.getA29() * A30 *
                (DD10 * DD19 * DD20 * DD18 * DD21 * DD22 + DD10 * DD19 * (1 - DD20) * DD18 * DD21 * DD22 + DD10 * DD19 *
                        DD20 * (1 - DD18) * DD21 * DD22 + DD10 * DD19 * DD20 * DD18 * (1 - DD21 * DD22) + DD10 * DD19 *
                        (1 - DD20) * (1 - DD18) * DD21 * DD22 + DD10 * DD19 * (1 - DD20) * DD18 * (1 - DD21 * DD22) +
                        DD10 * DD19 * DD20 * (1 - DD18) * (1 - DD21 * DD22));
